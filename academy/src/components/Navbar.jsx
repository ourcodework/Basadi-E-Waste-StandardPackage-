...
const Navbar = () => {
    ...
    return (
        <nav className="fixed top-0 left-0 right-0 z-50 bg-[#F6FBF6]/95 backdrop-blur-sm border-b border-[#D9EBE9]">
            <div className="container mx-auto px-6 py-6">
                <div className="flex items-center justify-between">
                    {/* Logo */}
                    <div className="flex items-center gap-3">
                        <img src={logo} width={100} height={100} alt="OurCode Logo" />
                        {/* <h1 className='font-bold text-2xl text-[#16A249]'>Academy</h1> */}
                    </div>
            ...
            {isOpen && (
                <div className="md:hidden border-t bg-background">
                    <div className="px-4 py-3 space-y-1">
                        <button
                            className="w-full justify-start hover:text-[#16A249] transition-colors duration-300"
                            onClick={() => scrollToSection("home")}
